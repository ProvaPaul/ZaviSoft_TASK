...
<body class="antialiased">
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            {{-- Foodpanda SSO Welcome --}}
            <div class="text-center mb-12">
                <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">🐼 Foodpanda App</h1>
                <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">OAuth2 SSO Client • Access is via Ecommerce
                    Single Sign-On</p>
                @guest
                    <div class="flex justify-center gap-4">
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center px-6 py-3 bg-pink-600 border border-transparent rounded-lg font-semibold text-white hover:bg-pink-700 focus:bg-pink-700 active:bg-pink-900 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 transition">Login
                            via Ecommerce SSO</a>
                    </div>
                    <p class="mt-4 text-sm text-gray-500 dark:text-gray-400">
                        Login at <a href="http://127.0.0.1:8000/login" class="underline text-pink-600">Ecommerce (port
                            8000)</a> then click "Go to Foodpanda"
                    </p>
                @endguest
            </div>
