    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 dark:text-gray-400 mb-6">OAuth2 SSO Authorization Server • Login to
                    access Dashboard & Go to Foodpanda</p>
                @guest
                    <div class="flex justify-center gap-4">
                        <a href="{{ route('register') }}"
                            class="inline-flex items-center px-6 py-3 bg-red-600 border border-transparent rounded-lg font-semibold text-white hover:bg-red-700 focus:bg-red-700 active:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition">Create
                            Account</a>
                        <a href="{{ route('login') }}"
                            class="inline-flex items-center px-6 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition">Log
                            in</a>
                    </div>
                    <p class="mt-4 text-sm text-gray-500 dark:text-gray-400">
                        Demo: <strong>admin@ecommerce.test</strong> / <strong>password</strong>
                    </p>
                @endguest
            </div>
