                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ old('name', $product->name) }}" placeholder="e.g. Widget Pro" required>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="purchase_price" id="purchase_price"
                                ...
                                value="{{ old('purchase_price', $product->purchase_price) }}" step="0.01" min="0.01"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="sell_price" id="sell_price"
                                ...
                                value="{{ old('sell_price', $product->sell_price) }}" step="0.01" min="0.01"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="stock" id="stock"
                                ...
                                value="{{ old('stock', $product->stock) }}" min="0" placeholder="50" required>
                            @error('stock')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
